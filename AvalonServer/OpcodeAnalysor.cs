...
namespace AvalonServer
{
    ...
    {
        enum FormNumber : int { Login, Lobby, Room, Game, playerInfo = 8, Shutdown }; // 통신 규약에 따른 각 폼의 번호
        string dataString;
        ...
        public CommunicationForm separateOpcode(bool printCheck)
        {
            ...
            form.argumentList = divideArgument(printCheck);
        ...
        string[] divideArgument(bool printCheck)
        {
